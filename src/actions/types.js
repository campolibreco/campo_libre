...
export const SITE_COUNTY_OPTION_CHANGED = 'site_county_option_changed';
export const SITE_FOREST_OPTION_CHANGED = 'site_forest_option_changed';
export const SITE_MVUM_OPTION_CHANGED = 'site_mvum_option_changed';
